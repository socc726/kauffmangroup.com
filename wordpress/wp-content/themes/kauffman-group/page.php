			...
			<div class="text-module">
				<?php while ( have_posts() ) : the_post(); ?>
					<div class="page-header">
						<h2><?php the_title(); ?></h2>
						<div class="well">To be a leader in the industry by providing each customer with superior land development and construction services in a specialized, timely manner through the utilization of a responsive, well trained team of professionals.</div>
					</div>
